...
export class PersenceService {
  ...
  createHubConccetion(user:user){
    ...
    this.hubConnection.on('NewMessageReceived',(message:Message)=>{
      this.toastService.info(message.senderDisplayName+' has sent you a new message',10000,message.senderImageUrl,
